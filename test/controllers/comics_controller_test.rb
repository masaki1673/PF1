...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { body: @comic.body, title: @comic.title, user_id: @comic.user_id } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { body: @comic.body, title: @comic.title, user_id: @comic.user_id } }
